...
10. Перейди в браузер и открой страничку [http://localhost:3003](http://localhost:3003/). Когда страничка загрузится, ты увидишь страницу с сообщением «Персональный проект: стартовая точка».
